...
func (c *Controller) ensureGoverningService(db *api.ProxySQL) error {
...
func (c *Controller) ensureService(db *api.ProxySQL) (kutil.VerbType, error) {
...
func (c *Controller) createPrimaryService(db *api.ProxySQL) (kutil.VerbType, error) {
	meta := metav1.ObjectMeta{
