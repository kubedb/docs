...
func (c *Controller) pushFailureEvent(etcd *dbapi.Etcd, reason string) {
	...
	db, err := kutildb.UpdateEtcdStatus(c.ExtClient.KubedbV1alpha1(), etcd, func(in *dbapi.EtcdStatus) *dbapi.EtcdStatus {
