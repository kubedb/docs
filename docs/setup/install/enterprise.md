...
KubeDB Enterprise edition is the open core version of [KubeDB](https://github.com/kubedb/operator). It comes with all the functionalities of KubeDB Community edition as well as some advanced features such as [Auto-Backup](/docs/guides/latest/auto-backup/overview.md), [Batch Backup](/docs/guides/latest/batch-backup/overview.md), and [Local Backend](/docs/guides/latest/backends/local.md) support, etc. A full features comparison between KubeDB Enterprise Edition and community version can be found [here](/docs/concepts/what-is-kubedb/overview.md).
...
KubeDB can be installed via [Helm](https://helm.sh/) using the [chart](https://github.com/kubedb/installer/tree/{{< param "info.enterprise" >}}/charts/kubedb-enterprise) from [AppsCode Charts Repository](https://github.com/appscode/charts). To install the chart with the release name `kubedb-enterprise`:
...
To see the detailed configuration options, visit [here](https://github.com/kubedb/installer/tree/{{< param "info.enterprise" >}}/charts/kubedb-enterprise).
...
KubeDB can be installed via [Helm](https://helm.sh/) using the [chart](https://github.com/kubedb/installer/tree/{{< param "info.enterprise" >}}/charts/kubedb-enterprise) from [AppsCode Charts Repository](https://github.com/appscode/charts). To install the chart with the release name `kubedb`:

```bash
$ helm repo add appscode https://charts.appscode.com/stable/
$ helm repo update
$ helm search appscode/kubedb-enterprise --version {{< param "info.enterprise" >}}
NAME                      CHART VERSION APP      VERSION             DESCRIPTION
appscode/kubedb-enterprise  {{< param "info.enterprise" >}}    {{< param "info.enterprise" >}}  KubeDB by AppsCode - Backup your Kubernetes Volumes
...
NAME                                      CREATED AT
backupbatches.kubedb.appscode.com          2020-08-24T08:20:54Z
backupblueprints.kubedb.appscode.com       2020-08-24T08:20:55Z
backupconfigurations.kubedb.appscode.com   2020-08-24T08:20:54Z
backupsessions.kubedb.appscode.com         2020-08-24T08:20:55Z
functions.kubedb.appscode.com              2020-08-24T08:20:55Z
recoveries.kubedb.appscode.com             2020-08-24T08:20:54Z
repositories.kubedb.appscode.com           2020-08-24T08:20:54Z
restics.kubedb.appscode.com                2020-08-24T08:20:54Z
restorebatches.kubedb.appscode.com         2020-08-24T08:20:55Z
restoresessions.kubedb.appscode.com        2020-08-24T08:20:55Z
tasks.kubedb.appscode.com                  2020-08-24T08:20:55Z
```

Now, you are ready to [take your first backup](/docs/guides/latest/README.md) using KubeDB.
