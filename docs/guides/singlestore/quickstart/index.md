...
- `spec.version` is the name of the SinglestoreVersion CRD where the docker images are specified. In this tutorial, a SingleStore `8.1.32` database is going to be created.
...
sdb-quickstart-master-aggregator   1/1     37s
...
data-sdb-quickstart-master-aggregator-0   Bound    pvc-75057e3d-e1d7-4770-905b-6049f2edbcde   1Gi        RWO            standard       <unset>                 46s
...
```bash
$ kubectl exec -it -n demo sdb-quickstart-master-aggregator-0 -- bash
  Defaulting container name to singlestore.
  Use 'kubectl describe pod/sdb-quickstart-master-aggregator-0 -n demo' to see all of the containers in this pod.
