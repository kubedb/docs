...
| Backup & Recovery (Instant, Scheduled, Restore from Snapshot via [KubeStash](https://kubestash.com/)) |   &#10003;   |
| Custom Configuration                                                                             |   &#10003;   |
| Reconfigure                                                                                      |   &#10003;   |
| TLS/SSL Encryption (Add, Rotate, Update, Remove via [Cert Manager](https://cert-manager.io/docs/)) |   &#10003;   |
| Monitoring with Prometheus (Builtin & Operator) & Grafana                                        |   &#10003;   |
