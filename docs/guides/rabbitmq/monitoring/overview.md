...
- Learn how to monitor RabbitMQ database with KubeDB using [builtin-Prometheus](/docs/guides/rabbitmq/monitoring/using-builtin-prometheus.md)
- Learn how to monitor RabbitMQ database with KubeDB using [Prometheus operator](/docs/guides/rabbitmq/monitoring/using-prometheus-operator.md).
