...
Read about the fields in details from [mariadb concept](/docs/guides/mariadb/concepts/mariadb.md#),
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/images/day-2-operation/mariadb/my-tls-ssl.png">
