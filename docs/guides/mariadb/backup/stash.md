...
# Backup & Restore MariaDB Using Stash
...
In order to backup MariaDB database using Stash, follow the following steps:
...
- **Install MariaDB Addon:** Then, you have to install MariaDB addon for Stash. Please, follow the steps from [here](https://stash.run/docs/latest/addons/mariadb/setup/install/).

- **Understand the Backup and Restore Flow:** Now, you can read about how MariaDB backup and restore works in Stash from [here](https://stash.run/docs/latest/addons/mariadb/overview/).

- **Get Started:** Finally, follow the step by step guideline to backup or restore your desired database version from [here](https://stash.run/docs/latest/addons/mariadb/).
