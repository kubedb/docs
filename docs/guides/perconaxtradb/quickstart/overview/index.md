...
<p align="center">
  <img alt="lifecycle"  src="/docs/guides/perconaxtradb/quickstart/overview/images/perconaxtradb-lifecycle.svg">
</p>

> Note: The yaml files used in this tutorial are stored in [here](https://github.com/kubedb/docs/tree/{{< param "info.version" >}}/docs/guides/perconaxtradb/quickstart/overview/examples).
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/perconaxtradb/quickstart/overview/examples/sample-pxc.yaml
