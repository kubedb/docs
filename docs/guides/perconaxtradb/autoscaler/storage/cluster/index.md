...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Storage Autoscaling Overview](/docs/guides/perconaxtradb/autoscaler/storage/overview)
...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/perconaxtradb/autoscaler/storage/cluster/examples/sample-pxc.yaml
