...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/guides/perconaxtradb/monitoring/overview).
...
> Note: YAML files used in this tutorial are stored in [docs/guides/perconaxtradb/monitoring/builtin-prometheus/examples](https://github.com/kubedb/docs/tree/{{< param "info.version" >}}/docs/guides/perconaxtradb/monitoring/builtin-prometheus/examples) folder in GitHub repository [kubedb/docs](https://github.com/kubedb/docs).
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/perconaxtradb/monitoring/builtin-prometheus/examples/prom-config.yaml
