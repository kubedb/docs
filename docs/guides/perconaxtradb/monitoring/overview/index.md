...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/guides/perconaxtradb/monitoring/overview/images/database-monitoring-overview.svg">
</p>
...
- Learn how to monitor `PerconaXtraDB` database with KubeDB using [builtin-Prometheus](/docs/guides/perconaxtradb/monitoring/builtin-prometheus) and using [Prometheus operator](/docs/guides/perconaxtradb/monitoring/prometheus-operator).
