...
**KubeDB / Hazelcast / Summary** — cluster-level overview:
- **Database Status** — current health of the Hazelcast cluster
- **Version** — Hazelcast version running
- **Cluster Members** — number of active members in the cluster
- **Entry Operations** — map put/get/remove rates across the cluster
- **Heap Usage** — JVM heap used vs. max across members
- **CPU / Network** — resource usage over time

<p align="center">
  <img alt="KubeDB Hazelcast Summary Dashboard" src="/docs/images/hazelcast/monitoring/hz-grafana-summary.png" style="padding:10px">
</p>

**KubeDB / Hazelcast / Pod** — per-member drill-down:
- **Uptime** — how long this member pod has been running
- **Owned Partitions** — number of partitions managed by this member
- **Entry Operations** — put/get/remove rates on this member
- **Heap Usage** — JVM heap on this pod
- **CPU / Memory** — per-pod resource usage

<p align="center">
  <img alt="KubeDB Hazelcast Pod Dashboard" src="/docs/images/hazelcast/monitoring/hz-grafana-pod.png" style="padding:10px">
</p>

**KubeDB / Hazelcast / Database** — map and cache metrics:
- **Map Entry Count** — number of entries per distributed map
- **Map Memory Cost** — heap cost of each map
- **Map Hit Rate** — cache effectiveness per map
- **Backup Entry Count** — entries held as backups per map

<p align="center">
  <img alt="KubeDB Hazelcast Database Dashboard" src="/docs/images/hazelcast/monitoring/hz-grafana-database.png" style="padding:10px">
</p>
