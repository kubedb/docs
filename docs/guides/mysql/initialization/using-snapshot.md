...
{{< notice type="warning" message="This doc has been deprecated and will be removed in a future release. We recommend to use [Stash](/docs/guides/mysql/snapshot/stash.md) to backup & restore MySQL database." >}}
...
```console
$ kubedb create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/mysql/Initialization/demo-2.yaml
