...
<figure align="center">
  <img alt="Update Version Process of Redis" src="/docs/images/day-2-operation/redis/rd-upgrading.svg">
...
- Learn how to Update Version of [Redis Standalone](/docs/guides/redis/upgrading/standalone.md)
- Learn how to Update Version of [Redis Cluster](/docs/guides/redis/upgrading/cluster.md)
- Learn how to Update Version of [Redis Sentinel](/docs/guides/redis/upgrading/sentinel.md)