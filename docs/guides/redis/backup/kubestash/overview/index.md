...
<figure align="center">
  <img alt="Redis Backup Overview" src="/docs/guides/redis/backup/kubestash/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/guides/redis/backup/kubestash/overview/images/restore_overview.svg">
...
- Backup a `Redis` database using KubeStash by the following guides from [here](/docs/guides/redis/backup/kubestash/logical/index.md).