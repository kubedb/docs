...
## Step 5: Import KubeDB Elasticsearch Dashboard — Option A: Automatically, via the `kubedb-grafana-dashboards` chart
...
## Step 5: Import KubeDB Elasticsearch Dashboard — Option B: Manually, by uploading JSON files
