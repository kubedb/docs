...
<figure align="center">
  <img alt="KubeDB + KubeStash" src="/docs/guides/elasticsearch/backup/kubestash/overview/images/kubedb_plus_kubestash.svg">
...
<figure align="center">
  <img alt="Elasticsearch Backup Overview" src="/docs/guides/elasticsearch/backup/kubestash/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/guides/elasticsearch/backup/kubestash/overview/images/restore_overview.svg">
...
- Backup a `Elasticsearch` database using KubeStash by the following guides from [here](/docs/guides/elasticsearch/backup/kubestash/logical/index.md).