...
If you deploy a database using [KubeDB](https://kubedb.com/docs/0.11.0/concepts/), the `AppBinding` object will be created automatically for it. Otherwise, you have to create an `AppBinding` object manually pointing to your desired database.
