...
- `spec:`
  ...
  - `connectionPool`
    - `authType`
Read about the fields in details from [pgbouncer concept](/docs/guides/pgbouncer/concepts/pgbouncer.md),
...
<figure align="center">
<img alt="Deploy PgBouncer with TLS/SSL" src="/docs/images/day-2-operation/pgbouncer/pb-tls.svg">
