...
Here, we are going to create a TLS secured standalone (ie. `replicas: 1`) Kafka cluster in Kraft mode. For this demo, we are going to provision kafka version `3.3.0`. To learn more about Kafka CR, visit [here](/docs/guides/kafka/concepts/kafka/index.md). visit [here](/docs/guides/kafka/concepts/catalog/index.md) to learn more about KafkaVersion CR.
