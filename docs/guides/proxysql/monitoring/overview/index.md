...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/guides/proxysql/monitoring/overview/images/database-monitoring-overview.svg">
</p>
...
- Learn how to monitor `ProxySQL` server with KubeDB using [builtin-Prometheus](/docs/guides/proxysql/monitoring/builtin-prometheus) and using [Prometheus operator](/docs/guides/proxysql/monitoring/prometheus-operator).
