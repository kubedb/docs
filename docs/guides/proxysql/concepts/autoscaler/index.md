...
`spec.databaseRef` is a required field that point to the [ProxySQL](/docs/guides/proxysql/concepts/proxysql) object for which the autoscaling will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [ProxySQL](/docs/guides/proxysql/concepts/proxysql) object.
