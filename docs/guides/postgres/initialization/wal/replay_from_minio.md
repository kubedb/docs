...
We need a WAL archive to perform initialization. If you don't have a WAL archive ready, get started by following the tutorial [here](/docs/guides/postgres/backup/wal/continuous_archiving.md).
MinIO specific archiving guides can be found [here](/docs/guides/postgres/backup/wal/archiving_to_minio.md).
...
Also cleanup the resources created for `wal-postgres-minio` following the guide [here](/docs/guides/postgres/backup/wal/archiving_to_minio.md#cleaning-up).
