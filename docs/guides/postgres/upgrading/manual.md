...
Note that, Once the DB version is updated, kubedb-operator will update the statefulsets too. This update strategy can be modified by `spec.updateStrategy`. Read [here](/docs/concepts/databases/postgres/#specupdatestrategy) for details about updateStrategy.
