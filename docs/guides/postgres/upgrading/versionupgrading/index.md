...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/postgres/upgrading/versionupgrading/yamls](/docs/guides/postgres/upgrading/versionupgrading/yamls) directory of [kubedb/docs](https://github.com/kube/docs) repository.
