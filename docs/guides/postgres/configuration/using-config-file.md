...
```bash
$ kubectl create secret generic -n demo pg-configuration --from-literal=user.conf="$(curl -fsSL https://raw.githubusercontent.com/kubedb/docs/v2025.6.30/docs/examples/postgres/custom-config/user.conf)"
