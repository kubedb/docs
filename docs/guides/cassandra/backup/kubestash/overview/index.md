...
<figure align="center">
  <img alt="KubeDB + KubeStash" src="/docs/guides/cassandra/backup/kubestash/overview/images/kubedb_plus_kubestash.svg">
...
- Backup a `Cassandra` database using KubeStash by the following guides from [here](/docs/guides/cassandra/backup/kubestash/logical/index.md).