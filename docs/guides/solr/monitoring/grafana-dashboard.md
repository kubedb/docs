...
## Step 5: Import KubeDB Solr Dashboards — Option A: Automatically, via the `kubedb-grafana-dashboards` chart
...
## Step 5: Import KubeDB Solr Dashboards — Option B: Manually, by uploading JSON files
