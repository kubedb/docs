...
{{< notice type="warning" message="This doc has been deprecated and will be removed in a future release. We recommend to use [Stash](/docs/guides/mongodb/snapshot/stash.md) to backup & restore MongoDB database." >}}
