...
- `spec:`
    ...
    - `tls:`
        ...
        - `certificates`
    - `cientAuthMode`
      Read about the fields in details from [ferretdb concept](/docs/guides/ferretdb/concepts/ferretdb.md),
...
<figure align="center">
<img alt="Deploy FerretDB with TLS/SSL" src="/docs/images/ferretdb/fr-tls.svg">
