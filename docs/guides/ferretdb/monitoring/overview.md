...
- Learn how to monitor FerretDB database with KubeDB using [builtin-Prometheus](/docs/guides/ferretdb/monitoring/using-builtin-prometheus.md)
- Learn how to monitor FerretDB database with KubeDB using [Prometheus operator](/docs/guides/ferretdb/monitoring/using-prometheus-operator.md).
